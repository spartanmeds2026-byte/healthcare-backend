...
export default class OdooRepository {
  ...
  static dbName = 'infraxio-nwo-main-20991687'
  static username = 'team@infraxio.com'

  static async getData() {
    const server = xmlrpc.createClient({ url: OdooRepository.url + '/xmlrpc/2/common' })

    server.methodCall('authenticate', [OdooRepository.dbName, OdooRepository.username, OdooRepository.apiKey, {}], function (error, value) {
      if (error) {
